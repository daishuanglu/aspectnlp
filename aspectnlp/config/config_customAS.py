...
class transfer_data_format():
    train='../custom_data/data_train_multi.csv'
    test='../custom_data/data_test_multi.csv'
    asp_header='keyword'
    txt_header='Response'
...
class configuration():
    ...
    pretrained='models/customAS_final.pt'
    transfer_domain=['models/customAS_text.pt','models/customAS_as.pt','models/customAS_sm.pt']
    # the new model name
    model_name='customAS'
    sentence=None
    target=None
